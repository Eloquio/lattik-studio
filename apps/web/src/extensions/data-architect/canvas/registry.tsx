...
import { Check, X, Plus, Trash2, Lock, Table2, Send, FileCode, ExternalLink } from "lucide-react";
...
export const { registry, handlers } = defineRegistry(catalog, {
  components: {
    ...
    // Receipt-style success card. Dashed perforation border, monospaced
    // key/value grid, double-bordered rubber-stamp success header — sits on
    // the cream notebook surface as a paper receipt instead of a floating
    // white panel.
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-start justify-between gap-3">
              ...
              <span className="font-mono text-[10px] uppercase tracking-wider text-stone-500">
                No. {String(props.prNumber).padStart(4, "0")}
              </span>
            </div>
            ...
            <div className="font-mono text-xs leading-relaxed text-stone-700">
              <div className="grid grid-cols-[auto_1fr] gap-x-3 gap-y-1.5">
                ...
                <span className="text-[#6b3410]">{props.name}</span>
              ...
              <>
                ...
                <div className="font-mono text-xs text-stone-700">
                  <div className="mb-1.5 flex items-baseline justify-between">
                    ...
                    <span className="text-stone-400">x{props.files.length}</span>
                  </div>
                  <ul className="flex flex-col gap-0.5">
                    {props.files.map((path: string, i: number) => (
