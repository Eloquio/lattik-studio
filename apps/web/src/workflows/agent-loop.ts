...
import { strictTool } from "../lib/agent/strict-tool";

// PipelineManager tools (pure)
import { listDagsTool } from "../agents/PipelineManager/tools/list-dags";
import { getDagDetailTool } from "../agents/PipelineManager/tools/get-dag-detail";
import { listDagRunsTool } from "../agents/PipelineManager/tools/list-dag-runs";
import { getTaskInstancesTool } from "../agents/PipelineManager/tools/get-task-instances";
import { getTaskLogsTool } from "../agents/PipelineManager/tools/get-task-logs";
import { renderDagOverviewTool } from "../agents/PipelineManager/tools/render-dag-overview";
import { renderDagRunDetailTool } from "../agents/PipelineManager/tools/render-dag-run-detail";
...
} from "../agents/DataArchitect/tools/render-forms";
import {
  listDefinitionsTool,
  getDefinitionTool,
...
} from "../agents/DataArchitect/tools/definition-flow";
import { createSubmitPRTool } from "../agents/DataArchitect/tools/submit-pr";
import { deleteDefinitionTool } from "../agents/DataArchitect/tools/delete-definition";
import { createReviewDefinitionTool } from "../agents/DataArchitect/tools/review-definition";
...
import {
  ...
  describeTableTool,
  runQueryTool,
} from "../agents/DataAnalyst/tools/data-tools";
import { renderSqlEditorTool } from "../agents/DataAnalyst/tools/render-tools";

// Assistant (concierge) — handoff is its only tool.
import { createHandoffTool } from "../agents/_tools/handoff";

// Shared tool — exposes the live canvas state to the agent so it can
// reason about user edits before re-rendering a form.
import { createReadCanvasStateTool } from "../agents/_tools/read-canvas-state";
