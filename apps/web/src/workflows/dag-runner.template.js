...
const fnName = process.env.O2FLOW_FN_NAME;
const ctx = JSON.parse(process.env.O2FLOW_CTX);
const timeoutMs = Number(process.env.O2FLOW_TIMEOUT_MS);
const callbackUrl = process.env.O2FLOW_CALLBACK_URL;
...
const callbackKey = Buffer.from(process.env.O2FLOW_CALLBACK_KEY, "hex");
const callbackToken = process.env.O2FLOW_CALLBACK_TOKEN;
const logToken = process.env.O2FLOW_LOG_TOKEN || "";
const logPort = Number(process.env.O2FLOW_LOG_PORT || 3000);
...
const oidcToken = process.env.O2FLOW_OIDC_TOKEN || "";
...
const SENSITIVE_VALUES = [
  process.env.O2FLOW_OIDC_TOKEN,
  process.env.O2FLOW_CALLBACK_KEY,
  process.env.O2FLOW_CALLBACK_TOKEN,
  process.env.O2FLOW_LOG_TOKEN,
]
