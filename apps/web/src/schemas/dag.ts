 ...
 *
 * Minimal surface for core scheduling — no template machinery, no
 * per-task `access:` capabilities, no `owners`. Add those back when the
 * corresponding features (templates, fine-grained access) are wanted.
 */
