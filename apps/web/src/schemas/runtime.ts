 ...
 *
 * The host serializes this as JSON and ships it via the
 * `LATTIK_TASK_CTX` env var; the sandbox runner parses it and invokes
 * `bundle[fnName](taskRunContext)`. Keep the surface minimal — task
 * authors who need more should pull from their own infra, not bloat
 * this type.
 */
