...
function GoogleSignIn() {
  return (
    ...
    >
      <button
        type="submit"
        className="flex items-center gap-3 rounded-lg border border-white/10 bg-white/10 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-white/20"
      >
...
function DevSignIn() {
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="w-full rounded-lg border border-white/10 bg-white/10 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-white/20"
      >
        Sign In
      </button>
